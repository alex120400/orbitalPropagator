...
groundstation_observation_input_file = "FFGroundObservations_STARLINK-1364_w_rf_c.txt"
tracking_report_output_file = "FFGroundObservations_STARLINK-1364_w_rf_c_converted.csv"
