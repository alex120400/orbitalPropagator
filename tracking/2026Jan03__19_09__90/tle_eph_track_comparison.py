...
if __name__ == "__main__":
    eph_base_file = "ASATrackingData_COSMOS-1506.eph"
    delayed_eph_file = "ASATrackingData_COSMOS-1506_delayed.eph"

    # add delay of 10 minutes to epochs in eph_base_file, run only once
    # delay_ephemeris(eph_base_file, delayed_eph_file, 10)

    tle_track_file = "trackingReport_COSMOS-1506.csv"
    ...
    compare_tracking_to_ephemeris([tle_track_file, eph_track_file_delay_reversed],
                                  eph_base_file,
